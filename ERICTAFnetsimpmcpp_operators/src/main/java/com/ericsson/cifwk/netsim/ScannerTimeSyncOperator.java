...
public class ScannerTimeSyncOperator implements UnitTestOperatorInterface {

	/** Taf command handler instance */
	private static CLICommandHelper cliCmdHelper;
	
	/** Logging utility */
	private static final Logger logger = LoggerFactory.getLogger(ScannerTimeSyncOperator.class);
	...
	public int verifyScriptExecution(String command) {
		logger.info("Verifying the process of fetching health check executions.");
