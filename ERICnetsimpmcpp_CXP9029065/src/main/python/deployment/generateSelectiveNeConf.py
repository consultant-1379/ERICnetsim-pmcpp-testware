...
def generateSelectiveNeConfigFile():
    ...
    try:
        ...
        for sim, c_map in previous_config.iteritems():
            for ne_type, s_c_map in c_map.iteritems():
                for rop, s_s_c_map in s_c_map.iteritems():
                    for ne_count, ne_list in s_s_c_map.iteritems():
