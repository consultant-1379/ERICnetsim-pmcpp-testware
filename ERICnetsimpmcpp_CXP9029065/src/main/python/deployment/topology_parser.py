...
def evaluate_topology_data(sim_name):
    ...
    for node, mo_data in topology_mo_map.iteritems():
        for mo, mo_value in mo_data.iteritems():
...
def main(argv):
    ...
    os.makedirs(TOPOLOGY_DATA_DIR, 0755)
    os.makedirs(NODE_TEMPLATE_MAP_DIR, 0755)
