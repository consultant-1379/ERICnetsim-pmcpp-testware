...
if [[ "${DEPL_TYPE}" = "NSS" ]]; then
   GENSTATS_LOCAL="SPITFIRE MGW SGSN RNC vMSC-HC vMSC MSC-BC-BSP MSC-BC-IS HLR-FE-IS HLR-FE-BSP CCPC CCRC CCSM CCDM CCES SC SMSF MRS R6274 R6675 R6672 R6673 R6676 R6678 R6371 R6471-1 R6471-2 R6273 PCC PCG"
   GENSTATS_UTC="MTAS CSCF SBG VSBG VBGF MRF WCG DSC HSS-FE IPWORKS UPG BSC VSAPC"
   PLAYBACK_LOCAL="EPG-OI vEPG-OI FrontHaul-6000"
else
   GENSTATS_LOCAL="R6675 R6672 SPITFIRE PCC PCG"
