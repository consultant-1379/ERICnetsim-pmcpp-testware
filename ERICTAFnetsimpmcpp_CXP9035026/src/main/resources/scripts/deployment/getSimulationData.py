...
FIVEG_NE_TYPES = ["VPP", "VRC", "RNNODE", "VTFRADIONODE", "5GRADIONODE"]
SUPPORTED_NE_TYPES = [ "CSCF", "EPG-EVR", "EPG-SSR", "MGW", "MTAS", "LTE", "MSRBS-V1", "MSRBS-V2", "PRBS", "ESAPC", "SBG", "SGSN", "SPITFIRE", "TCU", "RBS", "RNC", "RXI", "VBGF", "HSS-FE", "IPWORKS", "C608", "MRF", "UPG", "WCG", "VPP", "VRC", "RNNODE", "DSC", "WMG", "SIU", "EME", "VTFRADIONODE", "5GRADIONODE", "R6274", "R6672", "R6675", "R6371", "R6471-1", "R6471-2"]
...
def write_sim_data_to_file(sim_list, sim_info_map):
    ...
    for sim in sim_info_map:
        ...
        for node in node_info:
            ...
            if node_type in MSRBS_V1_NE_TYPES or node_type in MSRBS_V2_NE_TYPES:
