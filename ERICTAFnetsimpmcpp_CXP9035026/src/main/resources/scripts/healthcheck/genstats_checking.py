...
STATS_ONLY_NE_TYPES = [ "CSCF", "EPG-SSR", "EPG-EVR", "M-MGW", "MTAS", "SBG", "SPITFIRE", "TCU03", "TCU04", "MRSV", "HSS-FE", "IPWORKS", "MRFV", "UPG", "WCG", "DSC", "VPP", "VRC", "RNNODE", "WMG", "RBS", "STN", "EME", "VTFRADIONODE", "5GRADIONODE", "R6274", "R6672", "R6675", "R6371", "R6471-1", "R6471-2"]
startedNodesFile = "/tmp/showstartednodes.txt"
PLAYBACK_ONLY_NE_TYPES = ["FrontHaul"]
NON_EVENT_FIVEG_NODES = [ "VPP", "VRC", "RNNODE", "5GRADIONODE" ]
...
def check_stats_files(sims, lte_uetrace='', playbacksimlist=''):
    ...
    if os.path.isfile(startedNodesFile):
        for sim in sims:
                if sim in open(startedNodesFile).read():
                    ...
                    p = Process(target=check_stats_each_node, args=(sim, lte_uetrace, playbacksimlist,))
...
def check_stats_each_node(simname, lte_uetrace='', playbacksimlist=''):
    pm_data = "/c/pm_data/"
    bsc_ready_path = "/cdh/cdhdefault/Ready/"
...
''' % (program_shortdesc)
    ...
    check_stats_files(simlist, uetracelist, playbacksimlist)
